...
namespace BaSalesManagementApp.Business.Constants
{
    ...
    {       
        ...
        public static string STOCK_WAREHOUSE_RELATION => "Lütfen bir depo seçin.";
        public static string WAREHOUSE_NOT_FOUND { get; internal set; }
        ...
        //Badge CRUD İşlemleri ile ilgili mesajlar


        public const string BADGE_ADD_ERROR = "BADGE_ADD_ERROR";
        public const string BADGE_ADD_SUCCESS = "BADGE_ADD_SUCCESS";

        public const string BADGE_DELETE_ERROR = "BADGE_DELETE_ERROR";
        public const string BADGE_DELETE_SUCCESS = "BADGE_DELETE_SUCCESS";

        public const string BADGE_LISTED_ERROR = "BADGE_LISTED_ERROR";
        public const string BADGE_LISTED_SUCCESS = "BADGE_LISTED_SUCCESS";
        public const string BADGE_LISTED_NOTFOUND = "BADGE_LISTED_NOTFOUND";

        public const string BADGE_GETBYID_ERROR = "BADGE_GETBYID_ERROR";
        public const string BADGE_GETBYID_SUCCESS = "BADGE_GETBYID_SUCCESS";

        public const string BADGE_UPDATE_ERROR = "BADGE_UPDATE_ERROR";
        public const string BADGE_UPDATE_SUCCESS = "BADGE_UPDATE_SUCCESS";

        public const string BADGE_NAME_MAXIMUM_LENGTH = "BADGE_NAME_MAXIMUM_LENGTH";
        public const string BADGE_NAME_MINIMUM_LENGTH = "BADGE_NAME_MINIMUM_LENGTH";
        public const string BADGE_NAME_NOT_EMPTY = "BADGE_NAME_NOT_EMPTY";

        public const string BADGE_COMPANY_RELATION = "BADGE_COMPANY_RELATION";

        public const string BADGE_COMPANY_LISTED_DELETED = "BADGE_COMPANY_LISTED_DELETED";
        ...
        public const string ORDER_COMPANY_LISTED_SUCCESS = "ORDER_COMPANY_LISTED_SUCCESS";
        public const string ORDER_COMPANY_LIST_FAILED = "ORDER_COMPANY_LIST_FAILED";
        public const string ORDER_CUSTOMER_LIST_FAILED = "ORDER_CUSTOMER_LIST_FAILED";
        public const string ORDER_CUSTOMER_LIST_SUCCESS = "ORDER_CUSTOMER_LIST_SUCCESS";
        ...
        public const string CATEGORY_DELETE_FAILED_HAS_PRODUCTS = "CATEGORY_DELETE_FAILED_HAS_PRODUCTS";

        public const string CATEGORY_HAS_PRODUCT_SUCCESS = "CATEGORY_HAS_PRODUCT_SUCCESS";
        public const string CATEGORY_HAS_PRODUCT_FAILED = "CATEGORY_HAS_PRODUCT_FAILED";
		...
		#endregion
		#region Payment_Type Message
		// PaymentType messages
		public const string PAYMENT_TYPE_CREATED_SUCCESS = "Payment_Type_Created_Success";
        public const string PAYMENT_TYPE_DELETED_SUCCESS = "Payment_Type_Deleted_Success";
        public const string PAYMENT_TYPE_FOUND_SUCCESS = "Payment_Type_Found_Success";
        public const string PAYMENT_TYPE_LISTED_SUCCESS = "Payment_Type_Listed_Success";
        public const string PAYMENT_TYPE_UPDATED_SUCCESS = "Payment_Type_Updated_Success";

        public const string PAYMENT_TYPE_NOT_FOUND = "Payment_Type_Not_Found";
        public const string PAYMENT_TYPE_CREATE_FAILED = "Payment_Type_Create_Failed";
        public const string PAYMENT_TYPE_DELETE_FAILED = "Payment_Type_Delete_Failed";
        public const string PAYMENT_TYPE_LIST_EMPTY = "Payment_Type_List_Empty";
        public const string PAYMENT_TYPE_LIST_FAILED = "Payment_Type_List_Failed";
        public const string PAYMENT_TYPE_GET_FAILED = "Payment_Type_Get_Failed";
        public const string PAYMENT_TYPE_UPDATED_FAILED = "Payment_Type_Updated_Failed";

        //PaymentType Validations
        public const string PAYMENT_TYPE_NAMESPACE_IS_REQUIRED = "Payment_Type_Namespace_Is_Required";
        public const string PAYMENT_TYPE_MAX_LENGTH = "Payment_Type_Max_Length";
        public const string PAYMENT_TYPE_MIN_LENGTH = "Payment_Type_Min_Length";
        #endregion
        ...
        public const string PRODUCTTYPE_EXISTS = "PRODUCTTYPE_EXISTS";
        ...
        public const string PRODUCTTYPE_CATEGORY_NAME_CONFLICT = "PRODUCTTYPE_CATEGORY_NAME_CONFLICT";
        ...
        public const string Warehouse_DETAILS_LISTED_SUCCESS = "Warehouse_DETAILS_LISTED_SUCCESS";
        ...
        public const string STOCK_COMPANY_FOUND = "STOCK_COMPANY_FOUND";
        public const string STOCK_COMPANY_NOT_FOUND = "STOCK_COMPANY_NOT_FOUND";
        ...
        public const string STOCK_TYPE_SIZE_ALREADY_EXISTS = "STOCK_TYPE_SIZE_ALREADY_EXISTS";
        ...
        public const string CUSTOMER_LISTED_FOR_COMPANY = "CUSTOMER_LISTED_FOR_COMPANY";
        public const string CUSTOMER_NOTFOUND_FOR_COMPANY = "CUSTOMER_NOTFOUND_FOR_COMPANY";
        ...
        public const string CUSTOMER_EMAIL_NOT_EMPTY = "CUSTOMER_EMAIL_NOT_EMPTY";
        public const string CUSTOMER_EMAIL_INVALID = "CUSTOMER_EMAIL_INVALID";
        ...
        #region Currency
        public const string CURRENCY_LISTED_SUCCESS = "CURRENCY_LISTED_SUCCESS";
        public const string CURRENCY_LIST_ERROR = "CURRENCY_LIST_ERROR";

        public const string CURRENCY_NOT_FOUND = "CURRENCY_NOT_FOUND";
        public const string CURRENCY_RETRIEVED_SUCCESS = "CURRENCY_RETRIEVED_SUCCESS";
        public const string CURRENCY_RETRIEVED_ERROR = "CURRENCY_RETRIEVED_ERROR";
