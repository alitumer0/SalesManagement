...
namespace BaSalesManagementApp.Business.Interfaces
{
    public interface IBranchService
    {
        ...
        /// <param name="companyId">Branchlerine ulaşılmak istenen companynin benzersiz kimliği</param>
        /// <returns>Asenkron işlemi temsil eden bir görev. Görev sonucunda ilgili companye ait branchleri listeler</returns>
        Task<IDataResult<List<BranchListDTO>>> GetBranchesByCompanyIdAsynca(Guid companyId);

        /// <summary>
        /// Verilen branchId'ye ait bir depo (warehouse) olup olmadığını kontrol eder.
        /// </summary>
        /// <param name="branchId">Depoyu ilişkilendirecek şirket şubesinin benzersiz kimliği.</param>
        /// <returns>True, eğer belirtilen branchId'ye ait bir depo varsa; aksi takdirde false döner.</returns>
        Task<bool> HasWarehouseAsync(Guid branchId);
