...
namespace BaSalesManagementApp.Business.Interfaces
{
    public interface IWarehouseService
    {
        ...
        /// <summary>
        /// Belirtilen şubelere göre tüm depoları getirir.
        /// </summary>
        /// <param name="branches"></param>
        /// <returns> Depo listesini döner</returns>
        Task<List<Warehouse>> GetWarehousesByBranchIdAsync(List<Branch> branches);
        ...
        /// <param name="branches"></param>
        /// <returns> Depo listesini döner</returns>
        Task<IDataResult<List<WarehouseDTO>>> GetWarehousesByBranchIdAsynca(List<Branch> branches);

        /// <summary>
        /// Belirtilen idye göre tüm depoları getirir.
        /// </summary>
        /// <param name="companyId"></param>
        /// <returns> Depo listesini döner</returns>
        Task<IDataResult<List<WarehouseListDTO>>> GetAllAsyncByCompanyId(Guid? companyId);
    }
}
