...
public class CityService : ICityService
{
    ...
    /// <summary>
    /// Şehiri İD'sine göre siler
    /// </summary>
    /// <param name="cityId"> Şehirlere özel verilen değer</param>
    /// <returns>Başarılı yada başarısız silme işlemi</returns>
        ...
        try
        {
            ...
            switch (orderOrder.ToLower())
            {
                ...
                case "alphabeticaldesc":
                    ...
                    break;
                case "az-country":
                    cityList = cityList.OrderBy(c => c.CountryName).ToList();
                    break;
                case "za-country":
                    cityList = cityList.OrderByDescending(c => c.CountryName).ToList();
                    break;
                default:
                    cityList = cityList.OrderBy(c => c.Name).ToList();
                    break;
